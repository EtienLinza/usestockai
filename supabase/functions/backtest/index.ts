...
// ============================================================================
// (Signal-engine logic — aggregateToWeekly, computeWeeklyBias, hasDailyEntrySignal,
//  hasDailyMeanReversionEntry, classifyStock, blendProfiles, PROFILE_PARAMS,
//  INDEX_TICKERS, createSignalTracker, computeStrategySignal — now imported
//  from ../_shared/signal-engine-v2.ts above.)
// ============================================================================
