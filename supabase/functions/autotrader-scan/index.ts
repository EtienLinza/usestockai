...
// All adaptive constants (ROLLING_DD, CDAR_*, RISK_PROFILE_BASELINES,
// VOL_TARGET_*, CORR_LOOKBACK_BARS) and pure functions (spyTrendOf,
// isBearishMacro, vixRegimeOf, realizedVolAnnualized, volTargetScalar,
// adaptiveCorrThreshold, dailyReturns, pearson, computeEffectiveSettings)
// live in _shared/adaptive-context.ts — imported above. Do not add a local
// copy; edit the shared file only.
